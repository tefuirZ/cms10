...
return array(
    ...
    '1' => array('name' => '首页', 'icon' => 'xe625', 'sub' => array(
        '10' => array("show"=>1,"name" => '魔改二开设置', 'controller' => 'admin', 'action' => 'lock'),
    ...
    '2' => array('name' => '系统', 'icon' => 'xe62e', 'sub' => array(
        ...
        '293' => array("show"=>1,"name" => 'APP弹窗配置', 'controller' => 'system',			'action' => 'configapppopupwindow'),
        '294' => array("show"=>1,"name" => '任务中心配置', 'controller' => 'system',			'action' => 'configtaskarticle'),
        '295' => array("show"=>1,"name" => 'APP版本管理', 'controller' => 'appversion',			'action' => 'index'),
        '296' => array("show"=>1,"name" => 'APP启动图片配置', 'controller' => 'appsetting',			'action' => 'index'),
    ...
    '3' => array('name' => '基础', 'icon' => 'xe64b', 'sub' => array(
        ...
        '37' => array("show"=>1,'name' => '栏目分类管理', 'controller' => 'category',		'action' => 'index'),
        '3701' => array("show"=>0,'name' => '--栏目分类信息维护', 'controller' => 'category',		'action' => 'info'),
        '3702' => array("show"=>0,'name' => '--栏目分类删除', 'controller' => 'category',		'action' => 'del'),
        '3703' => array("show"=>0,'name' => '--栏目分类状态', 'controller' => 'category',		'action' => 'field'),

        '38' => array("show"=>1,'name' => '广告类型管理', 'controller' => 'adtype',		'action' => 'index'),
        '3801' => array("show"=>0,'name' => '--广告类型息维护', 'controller' => 'adtype',		'action' => 'info'),
        '3802' => array("show"=>0,'name' => '--广告类型删除', 'controller' => 'adtype',		'action' => 'del'),
        '3803' => array("show"=>0,'name' => '--广告类型状态', 'controller' => 'adtype',		'action' => 'field'),

        //'39' => array("show"=>1,'name' => '广告管理', 'controller' => 'ad',		'action' => 'index'),
        //'3901' => array("show"=>0,'name' => '--广告息维护', 'controller' => 'ad',		'action' => 'info'),
        //'3902' => array("show"=>0,'name' => '--广告删除', 'controller' => 'ad',		'action' => 'del'),
        //'3903' => array("show"=>0,'name' => '--广告状态', 'controller' => 'ad',		'action' => 'field'),


        '395' => array("show"=>1,'name' => '直播管理', 'controller' => 'zhibo',		'action' => 'index'),
        '396' => array("show"=>1,'name' => '游戏管理', 'controller' => 'youxi',		'action' => 'index'),
        
        '396' => array("show"=>1,'name' => '游戏管理', 'controller' => 'youxi',		'action' => 'index'),
        '397' => array("show"=>1,'name' => '消息通知', 'controller' => 'message',		'action' => 'index'),
        '3971' => array("show"=>0,'name' => '--消息通知维护', 'controller' => 'message','action' => 'info'),
        '3972' => array("show"=>0,'name' => '--消息通知删除', 'controller' => 'message','action' => 'del'),
        '3973' => array("show"=>0,'name' => '--消息通知', 'controller' => 'message','action' => 'field'),
        '398' => array("show"=>1,'name' => '群聊', 'controller' => 'groupchat',		'action' => 'index'),
        '3981' => array("show"=>0,'name' => '--群聊维护', 'controller' => 'groupchat','action' => 'info'),
        '3982' => array("show"=>0,'name' => '--群聊删除', 'controller' => 'groupchat','action' => 'del'),
        '3983' => array("show"=>0,'name' => '--群聊', 'controller' => 'groupchat','action' => 'field'),
    )),
