<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/www/wwwroot/app.990829.cn/application/admin/view/vod/index.html";i:1595426366;s:66:"/www/wwwroot/app.990829.cn/application/admin/view/public/head.html";i:1568100986;s:66:"/www/wwwroot/app.990829.cn/application/admin/view/public/foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="my-toolbar-box">
        ...
        <div class="center mb10">
            <form class="layui-form " method="post">
                <input type="hidden" value="<?php if(!empty($param['url'])): ?><?php echo $param['url']; else: endif; ?>" name="url">
                ...
                <div class="layui-input-inline w150">
                    <select name="vod_year">
                        ...
                        <?php if(is_array($vod_years) || $vod_years instanceof \think\Collection || $vod_years instanceof \think\Paginator): $i = 0; $__LIST__ = $vod_years;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $vo['vod_year']; ?>" <?php if($param['vod_year'] == $vo['vod_year']): ?>selected<?php endif; ?>><?php echo $vo['vod_year']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
