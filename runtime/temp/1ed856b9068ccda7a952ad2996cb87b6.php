     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_61d32a650732a=explode(',',$maccms['search_hot']); if(is_array($_61d32a650732a) || $_61d32a650732a instanceof \think\Collection || $_61d32a650732a instanceof \think\Paginator): if( count($_61d32a650732a)==0 ) : echo "" ;else: foreach($_61d32a650732a as $key=>$vo): if($key < 5): ?>
...
<?php endif; endif; endif; ?>
	...
	<span id="short2" class="share_link shorturl"><?php echo $obj['vod_name']; ?><?php echo $obj['art_name']; if($maccms['mid'] == 3): ?>专题-<?php echo $obj['topic_name']; endif; ?><?php echo $obj['vod_play_list'][$param['sid']]['urls'][$param['nid']]['name']; ?>-<?php echo $maccms['site_name']; ?>-http://<?php echo $maccms['site_url']; ?><?php echo mac_url_vod_play($obj,['sid'=>$param['sid'],'nid'=>$param['nid']]); ?></span>
