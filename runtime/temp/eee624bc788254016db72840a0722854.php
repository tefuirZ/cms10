<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"/www/wwwroot/app.990829.cn/application/admin/view/system/config.html";i:1569567790;s:66:"/www/wwwroot/app.990829.cn/application/admin/view/public/head.html";i:1568100986;s:66:"/www/wwwroot/app.990829.cn/application/admin/view/public/foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="app[share_url]" placeholder="" value="<?php echo $config['app']['share_url']; ?>" class="layui-input">
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label class="layui-form-label">分享背景图：</label>
                        <div class="layui-input-inline w600">
                            <input type="text" name="app[share_logo]" placeholder="图片地址或路径" value="<?php echo $config['app']['share_logo']; ?>" class="layui-input upload-input">
                        </div>
                        <div class="layui-input-inline ">
                            <button type="button" class="layui-btn layui-upload" lay-data="{data:{thumb:0,thumb_class:'site[share_logo]'}}" id="upload3">上传图片</button>
                        </div>
                    </div>
