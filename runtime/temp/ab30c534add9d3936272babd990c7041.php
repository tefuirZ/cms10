     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_61d329f6487da=explode(',',$maccms['search_hot']); if(is_array($_61d329f6487da) || $_61d329f6487da instanceof \think\Collection || $_61d329f6487da instanceof \think\Paginator): if( count($_61d329f6487da)==0 ) : echo "" ;else: foreach($_61d329f6487da as $key=>$vo): if($key < 5): ?>
...
<?php echo $conch['theme']['notice']['text']; ?>
    ...
    <div class="smlist_box list_m">
        ...
        <?php endforeach; endif; else: echo "" ;endif; else: $_61d329f648308=explode(',',$vo1['type_extend']['class']); if(is_array($_61d329f648308) || $_61d329f648308 instanceof \think\Collection || $_61d329f648308 instanceof \think\Paginator): if( count($_61d329f648308)==0 ) : echo "" ;else: foreach($_61d329f648308 as $key2=>$vo2): if($key2 < 5): ?>
    ...
    <div class="smlist_box list_m">
        ...
        <?php if($vo1['childids']||$vo1['parent']['childids']): $__TAG__ = '{"num":"5","parent":"'.$vo1['type_id'].'","order":"asc","by":"sort","id":"vo2","key":"key2"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key2 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($key2 % 2 );++$key2;?>
        <a class="num<?php echo $key2; ?>" href="<?php echo mac_url_type($vo2); ?>" title="<?php echo $vo2['type_name']; ?>"><?php echo mac_substring($vo2['type_name'],2); ?></a>
        <?php endforeach; endif; else: echo "" ;endif; else: $_61d329f6481c6=explode(',',$vo1['type_extend']['class']); if(is_array($_61d329f6481c6) || $_61d329f6481c6 instanceof \think\Collection || $_61d329f6481c6 instanceof \think\Paginator): if( count($_61d329f6481c6)==0 ) : echo "" ;else: foreach($_61d329f6481c6 as $key2=>$vo2): if($key2 < 5): ?>
		<a class="num<?php echo $key2; ?>" href="<?php echo mac_url_type($vo1,['class'=>$vo2],'show'); ?>" title="<?php echo $vo2; ?>"><?php echo mac_substring($vo2,2); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; endif; ?>
    </div>
</li>
    ...
    <div class="smlist_box list_m">
        ...
        <?php if($vo1['childids']||$vo1['parent']['childids']): $__TAG__ = '{"num":"5","parent":"'.$vo1['type_id'].'","order":"asc","by":"sort","id":"vo2","key":"key2"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key2 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($key2 % 2 );++$key2;?>
        <a class="num<?php echo $key2; ?>" href="<?php echo mac_url_type($vo2); ?>" title="<?php echo $vo2['type_name']; ?>"><?php echo mac_substring($vo2['type_name'],2); ?></a>
        <?php endforeach; endif; else: echo "" ;endif; else: $_61d329f64807b=explode(',',$vo1['type_extend']['class']); if(is_array($_61d329f64807b) || $_61d329f64807b instanceof \think\Collection || $_61d329f64807b instanceof \think\Paginator): if( count($_61d329f64807b)==0 ) : echo "" ;else: foreach($_61d329f64807b as $key2=>$vo2): if($key2 < 5): ?>
		<a class="num<?php echo $key2; ?>" href="<?php echo mac_url_type($vo1,['class'=>$vo2],'show'); ?>" title="<?php echo $vo2; ?>"><?php echo mac_substring($vo2,2); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; endif; ?>
    </div>
</li>
    ...
    <div class="smlist_box list_m">
        ...
        <?php if($vo1['childids']||$vo1['parent']['childids']): $__TAG__ = '{"num":"5","parent":"'.$vo1['type_id'].'","order":"asc","by":"sort","id":"vo2","key":"key2"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key2 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($key2 % 2 );++$key2;?>
        <a class="num<?php echo $key2; ?>" href="<?php echo mac_url_type($vo2); ?>" title="<?php echo $vo2['type_name']; ?>"><?php echo mac_substring($vo2['type_name'],2); ?></a>
        <?php endforeach; endif; else: echo "" ;endif; else: $_61d329f647eb5=explode(',',$vo1['type_extend']['class']); if(is_array($_61d329f647eb5) || $_61d329f647eb5 instanceof \think\Collection || $_61d329f647eb5 instanceof \think\Paginator): if( count($_61d329f647eb5)==0 ) : echo "" ;else: foreach($_61d329f647eb5 as $key2=>$vo2): if($key2 < 5): ?>
		<a class="num<?php echo $key2; ?>" href="<?php echo mac_url_type($vo1,['class'=>$vo2],'show'); ?>" title="<?php echo $vo2; ?>"><?php echo mac_substring($vo2,2); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; endif; ?>
    </div>
</li>
...
<?php endif; endforeach; endif; else: echo "" ;endif; ?>
	...
	<div class="topiclist_title">
	    ...
	    <p class="topiclist_blurb"><?php echo mac_default($vo['topic_sub'],'暂无简介'); ?></p>
	</div>
</li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
