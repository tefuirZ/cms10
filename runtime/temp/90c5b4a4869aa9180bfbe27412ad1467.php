<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/www/wwwroot/app.990829.cn/application/admin/view/system/configweixin.html";i:1568100986;s:66:"/www/wwwroot/app.990829.cn/application/admin/view/public/head.html";i:1568100986;s:66:"/www/wwwroot/app.990829.cn/application/admin/view/public/foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab">
            ...
            <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea type="text" name="weixin[guanzhu]" placeholder="用户关注你的公众号时自动回复的一句话" value="" class="layui-textarea"><?php echo $config['weixin']['guanzhu']; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">无资源回复：</label>
                    <div class="layui-input-block">
                        <textarea type="text" name="weixin[wuziyuan]" placeholder="用户搜索不到资源时默认返回的信息" value="" class="layui-textarea"><?php echo $config['weixin']['wuziyuan']; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
